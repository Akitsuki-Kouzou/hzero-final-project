...
@Table(name = "46319_invoice_apply_header")
@ExcelSheet(en="46319_InvoiceApplyHeader")
public class InvoiceApplyHeader extends AuditDomain {
    private static final long serialVersionUID = -47419934030829106L;
    ...
    @ApiModelProperty(value = "${column.comment}", required = true)
    @NotBlank
    @LovValue(lovCode = "46319_IAH_APPLYSTATUS", meaningField = "applyStatusMeaning")
    ...
    @ApiModelProperty(value = "${column.comment}", required = true)
    @NotBlank
    @LovValue(lovCode = "46319_IAH_INVCOLOR", meaningField = "invoiceColorMeaning")
    @ExcelColumn(en="Invoice Color",order = 8)
    private String invoiceColor;

    @Transient
    @ExcelColumn(en="Invoice Color Meaning",order = 8)
    private String invoiceColorMeaning;

    @ApiModelProperty(value = "${column.comment}", required = true)
    @NotBlank
    @LovValue(lovCode = "46319_IAH_INVTYPE", meaningField = "invoiceTypeMeaning")
    @ExcelColumn(en="Invoice Type",order = 9)
    ...
    @ExcelColumn(en="Bill To Person",order = 11)
    private String billToPerson;

    @ExcelColumn(en="Bill To Phone",order = 12)
    private String billToPhone;

    @ExcelColumn(en="Bill To Address",order = 13)
    private String billToAddress;

    @ExcelColumn(en="Bill To Email",order = 14)
    private String billToEmail;

    @ApiModelProperty(value = "${column.comment}", required = true)
    @NotNull
    @ExcelColumn(en="Total Amount",order = 15)
    private BigDecimal totalAmount;

    @ApiModelProperty(value = "${column.comment}", required = true)
    @NotNull
    @ExcelColumn(en="Exclude Tax Amount",order = 16)
    private BigDecimal excludeTaxAmount;

    @ApiModelProperty(value = "${column.comment}", required = true)
    @NotNull
    @ExcelColumn(en="Tax Amount",order = 17)
    private BigDecimal taxAmount;

    @ApiModelProperty(value = "${column.comment}", required = true)
    @NotNull
    @ExcelColumn(en="Del Flag",order = 18)
    private Integer delFlag;

    @ExcelColumn(en="Remark",order = 19)
