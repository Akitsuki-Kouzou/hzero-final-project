...
public class InvoiceApplyLineController extends BaseController {
    ...
    public ResponseEntity<InvoiceApplyLine> remove(@RequestBody List<InvoiceApplyLine> invoiceApplyLines) {
        ...
        for(InvoiceApplyLine line: invoiceApplyLines){
            InvoiceApplyLine invoiceApplyLine = invoiceApplyLineRepository.selectByPrimaryKey(line);
    ...
    public ResponseEntity<InvoiceApplyLine> deleteById(@PathVariable Long applyLineId) {
    ...
    public ResponseEntity<List<InvoiceApplyLine>> export(
        ...
        Page<InvoiceApplyLine> page = invoiceApplyLineService.selectListHN(pageRequest, invoiceApplyLine);
