...
@ImportValidators({@ImportValidator(templateCode = "46324.IAH.IMPORT")})
public class InvoiceApplyHeaderServiceValidator extends BatchValidatorHandler {
    @Override
    public boolean validate(List<String> data) {
        ...
        for (int i = 0; i < data.size(); i++) {
            ...
            if (isEmpty(invoiceApplyHeader.getApplyStatus())) {
                ...
                addErrorMsg(i,"Invalid Apply Status (allowed values: D, S, F, C)");
                isValid = false;
            }
            ...
            if (isEmpty(invoiceApplyHeader.getInvoiceColor())) {
                ...
                addErrorMsg(i,"Invalid Invoice Color (allowed values: R, B)");
                isValid = false;
            }
            ...
            if (isEmpty(invoiceApplyHeader.getInvoiceType())) {
                ...
                addErrorMsg(i,"Invalid Invoice Type (allowed values: P, E)");
                isValid = false;
            }
        }
        return isValid;
